 ...
 * escape handling), plus an optional small secondary link underneath for
 * visitors who aren't on iPhone — SneakySwing is iOS-only for now — to leave
 * their email for when Android support ships.
 */
