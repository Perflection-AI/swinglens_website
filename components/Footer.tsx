      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium text-subtle">
              <li><a href="#" className="hover:text-golf-600 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-golf-600 transition-colors">Terms of Service</a></li>
            </ul>
          </div>
        </div>
