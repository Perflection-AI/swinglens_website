      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-soft-xl border border-ink/10 p-8 md:p-12">
            <h1 className="text-4xl md:text-5xl font-display font-bold text-ink mb-4">TERMS AND CONDITIONS</h1>
            <p className="text-subtle mb-8">Last updated September 19, 2025</p>

            <div className="prose prose-lg max-w-none text-ink">
              <section id="agreement" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">AGREEMENT TO OUR LEGAL TERMS</h2>
                ...
                <p className="text-subtle mb-4">
                  We operate the website <a href="https://perflection.ai" className="text-golf-600 hover:text-golf-700 font-bold" target="_blank" rel="noopener noreferrer">https://perflection.ai</a> (the "<strong>Site</strong>"), the mobile application <strong>SneakySwing - Your AI Golf Copilot</strong> (the "<strong>App</strong>"), as well as any other related products and services that refer or link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").
                </p>
                <p className="text-subtle mb-4">
              ...
              <section id="services" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">1. OUR SERVICES</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="ip" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">2. INTELLECTUAL PROPERTY RIGHTS</h2>
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Our intellectual property</h3>
                <p className="text-subtle mb-4">
              ...
              <section id="userreps" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">3. USER REPRESENTATIONS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="userreg" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">4. USER REGISTRATION</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="purchases" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">5. PURCHASES AND PAYMENT</h2>
                <p className="text-subtle mb-4">
                ...
                <p className="text-subtle mb-4">
                  You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in <strong>US dollars</strong>.
                </p>
                <p className="text-subtle mb-4">
              ...
              <section id="subscriptions" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">6. SUBSCRIPTIONS</h2>
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Billing and Renewal</h3>
                <p className="text-subtle mb-4">
                  Your subscription will continue and automatically renew unless canceled. You consent to our charging your payment method on a recurring basis without requiring your prior approval for each recurring charge, until such time as you cancel the applicable order. The length of your billing cycle will depend on the type of subscription plan you choose when you subscribed to the Services.
                </p>
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Free Trial</h3>
                <p className="text-subtle mb-4">
                  We offer a <strong>30</strong>-day free trial to new users who register with the Services. <strong>The account will not be charged and the subscription will be suspended until upgraded to a paid version</strong> at the end of the free trial.
                </p>
              ...
              <section id="software" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">7. SOFTWARE</h2>
                <p className="text-subtle mb-4">
                  We may include software for use in connection with our Services. If such software is accompanied by an end user license agreement ("<strong>EULA</strong>"), the terms of the EULA will govern your use of the software. If such software is not accompanied by a EULA, then we grant to you a non-exclusive, revocable, personal, and non-transferable license to use such software solely in connection with our services and in accordance with these Legal Terms. Any software and any related documentation is provided "<strong>AS IS</strong>" without warranty of any kind, either express or implied, including, without limitation, the implied warranties of merchantability, fitness for a particular purpose, or non-infringement. You accept any and all risk arising out of use or performance of any software. You may not reproduce or redistribute any software except in accordance with the EULA or these Legal Terms.
                </p>
              </section>

              <section id="prohibited" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">8. PROHIBITED ACTIVITIES</h2>
                <p className="text-subtle mb-4">
                ...
                <ul className="list-disc pl-6 mb-4 text-subtle space-y-2">
                  ...
                  <li>Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or active information collection or transmission mechanism, including without limitation, clear graphics interchange formats ("<strong>gifs</strong>"), 1×1 pixels, web bugs, cookies, or other similar devices (sometimes referred to as "<strong>spyware</strong>" or "<strong>passive collection mechanisms</strong>" or "<strong>pcms</strong>").</li>
              ...
              <section id="ugc" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">9. USER GENERATED CONTRIBUTIONS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="license" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">10. CONTRIBUTION LICENSE</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="reviews" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">11. GUIDELINES FOR REVIEWS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="mobile" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">12. MOBILE APPLICATION LICENSE</h2>
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Use License</h3>
                <p className="text-subtle mb-4">
                ...
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Apple and Android Devices</h3>
                <p className="text-subtle mb-4">
                  The following terms apply when you use the App obtained from either the Apple Store or Google Play (each an "<strong>App Distributor</strong>") to access the Services: (1) the license granted to you for our App is limited to a non-transferable license to use the application on a device that utilizes the Apple iOS or Android operating systems, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor's terms of service; (2) we are responsible for providing any maintenance and support services with respect to the App as specified in the terms and conditions of this mobile application license contained in these Legal Terms or as otherwise required under applicable law, and you acknowledge that each App Distributor has no obligation whatsoever to furnish any maintenance and support services with respect to the App; (3) in the event of any failure of the App to conform to any applicable warranty, you may notify the applicable App Distributor, and the App Distributor, in accordance with its terms and policies, may refund the purchase price, if any, paid for the App, and to the maximum extent permitted by applicable law, the App Distributor will have no other warranty obligation whatsoever with respect to the App; (4) you represent and warrant that (i) you are not located in a country that is subject to a US government embargo, or that has been designated by the US government as a "<strong>terrorist supporting</strong>" country and (ii) you are not listed on any US government list of prohibited or restricted parties; (5) you must comply with applicable third-party terms of agreement when using the App, e.g., if you have a VoIP application, then you must not be in violation of their wireless data service agreement when using the App; and (6) you acknowledge and agree that the App Distributors are third-party beneficiaries of the terms and conditions in this mobile application license contained in these Legal Terms, and that each App Distributor will have the right (and will be deemed to have accepted the right) to enforce the terms and conditions in this mobile application license contained in these Legal Terms against you as a third-party beneficiary thereof.
                </p>
              </section>

              <section id="socialmedia" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">13. SOCIAL MEDIA</h2>
                <p className="text-subtle mb-4">
                  As part of the functionality of the Services, you may link your account with online accounts you have with third-party service providers (each such account, a "<strong>Third-Party Account</strong>") by either: (1) providing your Third-Party Account login information through the Services; or (2) allowing us to access your Third-Party Account, as is permitted under the applicable terms and conditions that govern your use of each Third-Party Account. You represent and warrant that you are entitled to disclose your Third-Party Account login information to us and/or grant us access to your Third-Party Account, without breach by you of any of the terms and conditions that govern your use of the applicable Third-Party Account, and without obligating us to pay any fees or making us subject to any usage limitations imposed by the third-party service provider of the Third-Party Account. By granting us access to any Third-Party Accounts, you understand that (1) we may access, make available, and store (if applicable) any content that you have provided to and stored in your Third-Party Account (the "<strong>Social Network Content</strong>") so that it is available on and through the Services via your account, including without limitation any friend lists and (2) we may submit to and receive from your Third-Party Account additional information to the extent you are notified when you link your account with the Third-Party Account. Depending on the Third-Party Accounts you choose and subject to the privacy settings that you have set in such Third-Party Accounts, personally identifiable information that you post to your Third-Party Accounts may be available on and through your account on the Services. Please note that if a Third-Party Account or associated service becomes unavailable or our access to such Third-Party Account is terminated by the third-party service provider, then Social Network Content may no longer be available on and through the Services. You will have the ability to disable the connection between your account on the Services and your Third-Party Accounts at any time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review any Social Network Content for any purpose, including but not limited to, for accuracy, legality, or non-infringement, and we are not responsible for any Social Network Content. You acknowledge and agree that we may access your email address book associated with a Third-Party Account and your contacts list stored on your mobile device or tablet computer solely for purposes of identifying and informing you of those contacts who have also registered to use the Services. You can deactivate the connection between the Services and your Third-Party Account by contacting us using the contact information below or through your account settings (if applicable). We will attempt to delete any information stored on our servers that was obtained through such Third-Party Account, except the username and profile picture that become associated with your account.
                </p>
              </section>

              <section id="thirdparty" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">14. THIRD-PARTY WEBSITES AND CONTENT</h2>
                <p className="text-subtle mb-4">
                  The Services may contain (or you may be sent via the Site or App) links to other websites ("<strong>Third-Party Websites</strong>") as well as articles, photographs, text, graphics, pictures, designs, music, sound, video, information, applications, software, and other content or items belonging to or originating from third parties ("<strong>Third-Party Content</strong>"). Such Third-Party Websites and Third-Party Content are not investigated, monitored, or checked for accuracy, appropriateness, or completeness by us, and we are not responsible for any Third-Party Websites accessed through the Services or any Third-Party Content posted on, available through, or installed from the Services, including the content, accuracy, offensiveness, opinions, reliability, privacy practices, or other policies of or contained in the Third-Party Websites or the Third-Party Content. Inclusion of, linking to, or permitting the use or installation of any Third-Party Websites or any Third-Party Content does not imply approval or endorsement thereof by us. If you decide to leave the Services and access the Third-Party Websites or to use or install any Third-Party Content, you do so at your own risk, and you should be aware these Legal Terms no longer govern. You should review the applicable terms and policies, including privacy and data gathering practices, of any website to which you navigate from the Services or relating to any applications you use or install from the Services. Any purchases you make through Third-Party Websites will be through other websites and from other companies, and we take no responsibility whatsoever in relation to such purchases which are exclusively between you and the applicable third party. You agree and acknowledge that we do not endorse the products or services offered on Third-Party Websites and you shall hold us blameless from any harm caused by your purchase of such products or services. Additionally, you shall hold us blameless from any losses sustained by you or harm caused to you relating to or resulting in any way from any Third-Party Content or any contact with Third-Party Websites.
                </p>
              </section>

              <section id="advertisers" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">15. ADVERTISERS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="sitemanage" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">16. SERVICES MANAGEMENT</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="copyrightyes" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">18. COPYRIGHT INFRINGEMENTS</h2>
                <p className="text-subtle mb-4">
                  We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately notify us using the contact information provided below (a "<strong>Notification</strong>"). A copy of your Notification will be sent to the person who posted or stored the material addressed in the Notification. Please be advised that pursuant to applicable law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located on or linked to by the Services infringes your copyright, you should consider first contacting an attorney.
                </p>
              </section>

              <section id="terms" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">19. TERM AND TERMINATION</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="modifications" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">20. MODIFICATIONS AND INTERRUPTIONS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="law" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">21. GOVERNING LAW</h2>
                <p className="text-subtle mb-4">
                  These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the Commonwealth of <strong>Pennsylvania</strong> applicable to agreements made and to be entirely performed within the Commonwealth of <strong>Pennsylvania</strong>, without regard to its conflict of law principles.
                </p>
              </section>

              <section id="disputes" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">22. DISPUTE RESOLUTION</h2>
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Informal Negotiations</h3>
                <p className="text-subtle mb-4">
                  To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "<strong>Dispute</strong>" and collectively, the "Disputes") brought by either you or us (individually, a "<strong>Party</strong>" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least <strong>thirty (30)</strong> days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.
                </p>
                ...
                <p className="text-subtle mb-4">
                  In no event shall any Dispute brought by either Party related in any way to the Services be commenced more than <strong>one (1)</strong> years after the cause of action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.
                </p>
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Restrictions</h3>
                <p className="text-subtle mb-4">
                  The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
                </p>
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Exceptions to Informal Negotiations and Arbitration</h3>
                <p className="text-subtle mb-4">
              ...
              <section id="corrections" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">23. CORRECTIONS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="disclaimer" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">24. DISCLAIMER</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="liability" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">25. LIMITATIONS OF LIABILITY</h2>
                <p className="text-subtle mb-4">
                  IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE <strong>six (6)</strong> MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR <strong>$5,000.00 USD</strong>. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.
                </p>
              </section>

              <section id="indemnification" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">26. INDEMNIFICATION</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="userdata" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">27. USER DATA</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="electronic" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">28. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="sms" className="mb-8">
                ...
                <h3 className="text-xl font-display font-bold text-ink mt-6 mb-3">Message and Data Rates</h3>
                <p className="text-subtle mb-4">
              ...
              <section id="california" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">30. CALIFORNIA USERS AND RESIDENTS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="misc" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">31. MISCELLANEOUS</h2>
                <p className="text-subtle mb-4">
              ...
              <section id="contact" className="mb-8">
                <h2 className="text-2xl font-display font-bold text-ink mt-8 mb-4">32. CONTACT US</h2>
                <p className="text-subtle mb-4">
                  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
                </p>
                <p className="text-subtle mb-4">
                  <strong>Perflection.AI, Inc.</strong><br />
                  <strong>4620 Henry Street</strong><br />
                  <strong>Pittsburgh</strong>, <strong>PA</strong> <strong>15213</strong><br />
