          ...
          <div className="bg-white rounded-2xl shadow-soft-xl border border-ink/10 p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-ink">
              ...
              <ul className="list-disc pl-6 mb-6 text-subtle space-y-2">
                ...
                <li>Use the mobile application <strong>SneakySwing - Your AI Golf Copilot</strong> (the "<strong>App</strong>"), as well as any other related products and services.</li>
